...
const RulesPage = () => {
  return (
    <div className="min-h-screen bg-zinc-950 text-slate-100 px-6 py-10">
      <h1 className="font-semibold text-4xl text-left mb-9 underline decoration-orange-600 text-center">
        Rules
      </h1>
      <ul>
        <li className="text-lg text-left pb-6">
        ...
        <li className="text-lg text-left pb-5">
